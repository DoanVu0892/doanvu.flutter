...
class UpdateDentistWithClinicBloc
    extends Bloc<UpdateDentistWithClinicEvent, UpdateDentistWithClinicState> {
  final AppRepository appRepository;
  UpdateDentistWithClinicBloc({this.appRepository})
      : assert(appRepository != null),
        super(UpdateDentistWithClinicInitial());

  @override
  Stream<UpdateDentistWithClinicState> mapEventToState(
      UpdateDentistWithClinicEvent updateDentistWithClinicEvent) async* {
    if (updateDentistWithClinicEvent is UpdateDentistWithClinicEventRequested) {
      ...
      try {
        final BaseResponse response = await new Future.delayed(
          ...
          return appRepository.updateDentistWithClinicId(
              updateDentistWithClinicEvent.listUpdate,
              updateDentistWithClinicEvent.date);
        });
