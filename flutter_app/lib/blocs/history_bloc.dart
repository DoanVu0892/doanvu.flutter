...
class HistoryBloc extends Bloc<HistoryEvent, HistoryState>{
  ...
  HistoryBloc({this.appRepository}) : assert(appRepository != null), super(HistoryStateInitial());
  ...
  Stream<HistoryState> mapEventToState(HistoryEvent historyEvent) async* {
    if(historyEvent is HistoryEventRequested){
      ...
      try{
        final HistoryResponse response = await new Future.delayed(Duration(milliseconds: Constant.duration),(){
