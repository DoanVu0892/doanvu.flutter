...
class ClinicResponse extends Equatable {
  ...
  const ClinicResponse(
      {this.status, this.message, this.statusCode, this.dataList});
...
class ClinicAddResponse extends Equatable {
  ...
  const ClinicAddResponse({this.name, this.phone, this.address});
  @override
  // TODO: implement props
...
class ClinicEditResponse extends Equatable {
  ...
  const ClinicEditResponse({this.statusCode, this.status, this.message});
  @override
  // TODO: implement props
